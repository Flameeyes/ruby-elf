# -*- coding: utf-8 -*-
# Copyright © 2009-2010 Diego Elio Pettenò <flameeyes@flameeyes.com>
#
...
class TC_Symbols_Comparison < Test::Unit::TestCase
  def setup
    @versioned_library = Elf::File.new(get_test_file("linux/amd64/gcc/versioning.so"))
    @unversioned_library = Elf::File.new(get_test_file("linux/amd64/gcc/versioning-unversioned.so"))
    @versioned_user = Elf::File.new(get_test_file("linux/amd64/gcc/versioning-user-versioned"))
